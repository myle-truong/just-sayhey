                        ...
                        onStart: function onStart() {
                           if ((i.pause(), !r)) {
                              var t =
                                 ...
                                 Math.abs(
                                    (n -
                                       (a && 'time' in a ? a.time : i._time)) /
                                       i.timeScale()
                                 );
                              h._dur !== t &&
                                 Ia(h, t, 0, 1).render(h._time, !0, !0),
                                 (r = 1);
                           }
                           s && s.apply(h, o || []);
                        },
               ...
               if (
                  ...
                  for (u = 0; u < l; u++) {
                     ...
                     (h.stagger = 0),
                        ...
                        (h.delay =
                           (+Vt(g, _assertThisInitialized(a), u, d, A) || 0) -
                           a._delay),
                        !b &&
                           1 === l &&
                           h.delay &&
         ...
         return (
            ...
            (e.kill = function kill(t, e) {
               if ((void 0 === e && (e = 'all'), !(t || (e && 'all' !== e))))
                  return (
                     (this._lazy = this._pt = 0), this.parent ? kb(this) : this
                  );
               if (this.timeline) {
   ...
   function Ld(t, e, r, i, n, a) {
      ...
      r
         ? l !== Ge &&
           ...
           (x = u))
         : ((w =
              (s = ud(t)).x + (~T[0].indexOf('%') ? (w / 100) * s.width : w)),
           (x =
              s.y + (~(T[1] || T[0]).indexOf('%') ? (x / 100) * s.height : x))),
         i || (!1 !== i && h.smooth)
            ? ((y = w - f),
              (b = x - d),
